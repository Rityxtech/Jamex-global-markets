        ...
        <div className="flex-1 p-2.5 md:p-margin-desktop space-y-2.5 md:space-y-6 max-w-[1600px] mx-auto w-full mb-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2.5 md:gap-gutter">
                ...
                <section className="lg:col-span-2 space-y-2.5 md:space-y-gutter">
                    <div className="glass-card rounded-xl overflow-hidden border border-outline-variant/20">
                        <div className="bg-surface-container-high/40 px-2.5 py-1.5 md:px-card-padding md:py-3 border-b border-outline-variant/10">
                            <h2 className="text-xs md:text-base font-bold text-primary flex items-center gap-1.5 md:gap-2 uppercase tracking-wide">
                                <span className="material-symbols-outlined text-[16px] md:text-[24px]">security</span>
                        ...
                        <div className="px-2.5 py-1.5 md:p-card-padding space-y-2 md:space-y-6">
                            ...
                            <div className="flex items-center justify-between py-1 md:py-1.5 border-b border-outline-variant/10 pb-2 md:pb-3">
                                <div>
                                    <p className="text-sm md:text-base font-bold text-on-surface mb-0.5">Two-Factor Authentication (2FA)</p>
                                    <p className="text-[11px] md:text-sm font-medium text-on-surface-variant">Protect your account with an extra layer of security.</p>
                                </div>
                            ...
                            <div className="space-y-1.5 md:space-y-4">
                                <p className="text-sm md:text-base font-bold text-on-surface">Change Password</p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5 md:gap-4">
                                    <div className="space-y-0.5 md:space-y-1">
                                        <label className="text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider">Current Password</label>
                                        <input 
                                            value={currentPassword}
                                            onChange={(e) => setCurrentPassword(e.target.value)}
                                            className="w-full bg-surface-container-lowest border border-outline-variant/50 rounded-lg px-2.5 py-1 md:px-4 md:py-2.5 text-sm md:text-lg text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" 
                                            placeholder="••••••••" 
                                            type="password" 
                                        />
                                    </div>
                                    <div className="space-y-0.5 md:space-y-1">
                                        <label className="text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider">New Password</label>
                                        <input 
                                            value={newPassword}
                                ...
                                <div className="flex items-center gap-4 mt-1 md:mt-2">
                                    <button 
                                        ...
                                        className="w-full md:w-auto bg-primary text-on-primary px-3 py-1.5 md:px-6 md:py-2.5 rounded-lg text-[11px] md:text-sm font-bold uppercase tracking-wider hover:brightness-110 transition-all active:scale-95 shadow-sm shadow-primary/20"
                                    >
                                        Update Password
                                    </button>
                                    {passwordMessage && (
                                        <span className="text-xs md:text-base font-medium text-primary">{passwordMessage}</span>
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="glass-card rounded-xl overflow-hidden border border-outline-variant/20">
                        <div className="bg-surface-container-high/40 px-2.5 py-2 md:px-card-padding md:py-3 border-b border-outline-variant/10">
                            <h2 className="text-xs md:text-base font-bold text-primary flex items-center gap-1.5 md:gap-2 uppercase tracking-wide">
                                <span className="material-symbols-outlined text-[16px] md:text-[24px]">notifications_active</span>
                        ...
                        <div className="p-0 overflow-x-auto scrollbar-hide">
                            <table className="w-full text-left min-w-[320px]">
                                <thead className="border-b border-outline-variant/10 bg-surface-container-highest/20">
                                    <tr>
                                        <th className="px-2.5 py-2 md:px-card-padding md:py-3 text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider">Activity Type</th>
                                        <th className="px-2.5 py-2 md:px-card-padding md:py-3 text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider text-center">Email</th>
                                        <th className="px-2.5 py-2 md:px-card-padding md:py-3 text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider text-center">Push</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-outline-variant/5">
                                    <tr className="hover:bg-white/5 transition-colors">
                                        <td className="px-2.5 py-2 md:px-card-padding md:py-4 text-xs md:text-base font-medium text-on-surface">Market Execution Alerts</td>
                                    ...
                                    <tr className="hover:bg-white/5 transition-colors">
                                        <td className="px-2.5 py-2 md:px-card-padding md:py-4 text-xs md:text-base font-medium text-on-surface">Wallet Deposits & Withdrawals</td>
                                        <td className="px-2.5 py-2 md:px-card-padding md:py-4 text-center">
                                            <input 
                                    ...
                                    <tr className="hover:bg-white/5 transition-colors">
                                        <td className="px-2.5 py-2 md:px-card-padding md:py-4 text-xs md:text-base font-medium text-on-surface">Security Login Notifications</td>
                                        <td className="px-2.5 py-2 md:px-card-padding md:py-4 text-center">
                                            <input 
                ...
                <aside className="space-y-2.5 md:space-y-gutter">
                    <div className="glass-card rounded-xl overflow-hidden border border-outline-variant/20">
                        <div className="bg-surface-container-high/40 px-2.5 py-1.5 md:px-card-padding md:py-3 border-b border-outline-variant/10">
                            <h2 className="text-xs md:text-base font-bold text-primary flex items-center gap-1.5 md:gap-2 uppercase tracking-wide">
                                <span className="material-symbols-outlined text-[16px] md:text-[24px]">tune</span>
                                Display Preferences
                            </h2>
                        </div>
                        <div className="px-2.5 py-1.5 md:p-card-padding space-y-2 md:space-y-6">
                            <div className="space-y-0.5 md:space-y-1">
                                <label className="text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider">Base Currency</label>
                                <select 
                                    value={baseCurrency}
                                    onChange={(e) => updateSetting('base_currency', e.target.value)}
                                    className="w-full bg-surface-container-lowest border border-outline-variant/50 rounded-lg px-2.5 py-1 md:px-4 md:py-2.5 text-sm md:text-lg font-medium text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all">
                            ...
                            <div className="space-y-0.5 md:space-y-1">
                                <label className="text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider">Timezone</label>
                                <select 
                                    value={timezone}
                            ...
                            <div className="space-y-0.5 md:space-y-1">
                                <label className="text-[11px] md:text-sm font-bold text-on-surface-variant uppercase tracking-wider">Date Format</label>
                                <div className="flex gap-2">
                                    <button 
                                        onClick={() => updateSetting('date_format', 'MM/DD/YYYY')}
                                        className={`flex-1 py-1 md:py-1.5 text-[11px] md:text-sm font-bold uppercase tracking-wider rounded-lg transition-colors ${dateFormat === 'MM/DD/YYYY' ? 'border border-primary text-primary bg-primary/10 shadow-sm' : 'border border-outline-variant/50 bg-surface-container-low text-on-surface-variant hover:border-primary/50'}`}>
                                        MM/DD/YYYY
                                    </button>
                                    <button 
                                        onClick={() => updateSetting('date_format', 'DD/MM/YYYY')}
                                        className={`flex-1 py-1 md:py-1.5 text-[11px] md:text-sm font-bold uppercase tracking-wider rounded-lg transition-colors ${dateFormat === 'DD/MM/YYYY' ? 'border border-primary text-primary bg-primary/10 shadow-sm' : 'border border-outline-variant/50 bg-surface-container-low text-on-surface-variant hover:border-primary/50'}`}>
                                        DD/MM/YYYY
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="glass-card rounded-xl p-2.5 md:p-card-padding flex flex-col items-center text-center gap-2.5 md:gap-4 border border-primary/30 bg-primary/5 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-sm md:text-base font-bold text-on-surface tracking-wide">Institutional Concierge</h3>
                            <p className="text-[11px] md:text-sm font-medium text-on-surface-variant mt-1 leading-snug px-1 md:px-2">Need assistance with advanced configuration? Specialists available 24/7.</p>
                        </div>
                        <button onClick={() => navigate('/support')} className="w-full md:w-auto bg-transparent border border-primary/50 text-primary px-4 py-2 rounded-lg text-[11px] md:text-sm font-bold uppercase tracking-wider hover:bg-primary hover:text-on-primary transition-all active:scale-95 relative z-10 mt-1">Contact Advisor</button>
                    </div>
                </aside>
            </div>
            ...
            <div className="mt-2.5 md:mt-gutter glass-card rounded-xl overflow-hidden border border-error/30">
                <div className="bg-error/10 px-2.5 py-2 md:px-card-padding py-3 border-b border-error/20 flex items-center gap-1.5 md:gap-2">
                    <span className="material-symbols-outlined text-error text-[16px] md:text-[24px]">warning</span>
                    <h2 className="text-xs md:text-base font-bold text-error uppercase tracking-wide">Danger Zone</h2>
                </div>
